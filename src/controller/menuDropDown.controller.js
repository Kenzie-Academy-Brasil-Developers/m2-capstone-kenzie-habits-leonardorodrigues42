    ...
    this.iconImage.addEventListener("click", async (e) => {
      ...
      btnEdit.addEventListener("click", async () => {
        ...
        btnSave.addEventListener("click", async (event) => {
          const inputNameEditProfile = document.querySelector(
            ".inputNameEditProfile"
          );
          const inputUrlEditProfile = document.querySelector(
            ".inputUrlEditProfile"
          );
          const inputNameEditProfileError = document.querySelector(
            ".inputNameEditProfileError"
          );
          const inputUrlEditProfileError = document.querySelector(
